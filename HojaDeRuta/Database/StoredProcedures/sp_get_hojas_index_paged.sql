...
BEGIN
    ...
    (
        id NVARCHAR(MAX) COLLATE DATABASE_DEFAULT NULL,
        usuario NVARCHAR(MAX) COLLATE DATABASE_DEFAULT NULL,
        equipo NVARCHAR(MAX) COLLATE DATABASE_DEFAULT NULL,
        cliente INT NULL,
        sector NVARCHAR(MAX) COLLATE DATABASE_DEFAULT NULL,
        subarea NVARCHAR(MAX) COLLATE DATABASE_DEFAULT NULL,
        numeracion NVARCHAR(MAX) COLLATE DATABASE_DEFAULT NULL,
        descripcion NVARCHAR(MAX) COLLATE DATABASE_DEFAULT NULL,
        socio_firmante NVARCHAR(MAX) COLLATE DATABASE_DEFAULT NULL,
        sindica NVARCHAR(MAX) COLLATE DATABASE_DEFAULT NULL,
        contrato NVARCHAR(MAX) COLLATE DATABASE_DEFAULT NULL,
        preparo NVARCHAR(MAX) COLLATE DATABASE_DEFAULT NULL,
        reviso NVARCHAR(MAX) COLLATE DATABASE_DEFAULT NULL,
        revisogte NVARCHAR(MAX) COLLATE DATABASE_DEFAULT NULL,
        revisosocio NVARCHAR(MAX) COLLATE DATABASE_DEFAULT NULL,
        ...
        fecha_modif NVARCHAR(MAX) COLLATE DATABASE_DEFAULT NULL,
        hora_modif NVARCHAR(MAX) COLLATE DATABASE_DEFAULT NULL,
        estado INT NULL,
        mailasociado NVARCHAR(MAX) COLLATE DATABASE_DEFAULT NULL,
        generico NVARCHAR(MAX) COLLATE DATABASE_DEFAULT NULL,
        revisoengagement NVARCHAR(MAX) COLLATE DATABASE_DEFAULT NULL,
        nivel_doc INT NULL,
        manejador NVARCHAR(MAX) COLLATE DATABASE_DEFAULT NULL,
        fecha_limite NVARCHAR(MAX) COLLATE DATABASE_DEFAULT NULL,
        lugar_firma NVARCHAR(MAX) COLLATE DATABASE_DEFAULT NULL,
        manejador_final NVARCHAR(MAX) COLLATE DATABASE_DEFAULT NULL,
        revisoengagement_fecha NVARCHAR(MAX) COLLATE DATABASE_DEFAULT NULL,
        Fecha DATE NULL,
        fecha_cierre DATE NULL,
        adjuntos NVARCHAR(MAX) COLLATE DATABASE_DEFAULT NULL,
        archivo_temp NVARCHAR(MAX) COLLATE DATABASE_DEFAULT NULL,
        archivo_hash NVARCHAR(MAX) COLLATE DATABASE_DEFAULT NULL,
        ClienteName NVARCHAR(MAX) COLLATE DATABASE_DEFAULT NULL
    );
    ...
    WITH SociosUnicos AS
    (
        SELECT
            mail COLLATE DATABASE_DEFAULT AS mail,
            MIN(Detalle) AS Detalle
        FROM dbo.SOCIOS
        GROUP BY mail
    ),
    Base AS
    (
        SELECT
            ...
            h.estado AS Estado
        FROM #BaseHojas h
        LEFT JOIN SociosUnicos sf
            ON sf.mail = h.revisosocio COLLATE DATABASE_DEFAULT
        WHERE
            (@Numero IS NULL OR h.numeracion LIKE '%' + @Numero + '%')
            ...
            *,
            ...
            (
                ORDER BY
                    ...
                    END DESC,
                    CASE
                        WHEN @SortField = N'NombreGenerico'
                         AND @SortDirection = N'asc'
                        THEN NombreGenerico
                    END ASC,
                    CASE
                    ...
                    END DESC,
                    CASE
                        WHEN @SortField = N'SocioFirmanteDetalle'
                         AND @SortDirection = N'asc'
                        THEN SocioFirmanteDetalle
                    END ASC,
                    CASE
                        WHEN @SortField = N'SocioFirmanteDetalle'
                         AND @SortDirection = N'desc'
                    ...
                    END DESC,
                    CASE
                        WHEN @SortField = N'FechaDocumento'
                         AND @SortDirection = N'asc'
                        THEN FechaDocumento
                    END ASC,
                    CASE
